...
namespace Onyx
{
    ...
    class Parser : IParser
    {
        ...
        private Node factor()
        {
            ...
            if (TokenDeclaration.isNumber(token.getToken()))
            {
        ...
        private Node dataType()
        {
            ...
            {
                if (TokenDeclaration.isDataType(token.getToken()))
                {
                    return new Node(token);
                }
                else
        ...
        {
            if (TokenDeclaration.isDataType(currentToken().getToken()))
            {
        ...
        //Public function, that return string with
        //variable list
        //example of print:
        //Declaration var:
        //Var: float f
        ...
        //Return string with used in source code values
        public string returnValues()
        {
            String result = "Declaration value: ";
            foreach (String value in values)
            {
                result += value + "\n";
            }
